  ...
  <div class="rows">
    <div class="d-flex flex-column">
      ...
      <div class="container is-fluid mb-5">
        <h1 class="header-title title is-4">This Month:</h1>
        <div class="columns">
          <transition name="fade-in" appear>
            <div class="column">
              <section
                class="hero is-primary admin-gradient px-5 d-flex align-items-center rounded-big"
              >
      ...
      <div class="container is-fluid mt-4">
        <div class="columns">
          <div class="column">
            <h1 class="header-title title is-5">Player Visits:</h1>
            <fusioncharts
          ...
          <div class="column">
            <h1 class="header-title title is-5">Games Genre Distribution:</h1>
            <fusioncharts
      ...
      <div class="container is-fluid mt-5">
        <div class="columns">
          <div class="column">
            <h1 class="header-title title is-5">
              Developer Saturation by Region:
            </h1>
            <fusioncharts
